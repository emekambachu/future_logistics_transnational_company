...
@section('contents')
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="header-inner">
                            <!-- header inner -->
                            <h1 class="title">Future Logistic Transnational Company</h1>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="single-header-bottom-item white">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Future Logistic Transnational Company Port is the most efficient port in the region, with a sub-3 hour turnaround.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-12">
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="single-header-bottom-item white">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Future Logistic Transnational Company Port offers the fastest customs clearance of any country in the GCC.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title b-top desktop-center padding-top-25 margin-bottom-55">
                        <h2 class="title">WE PROVIDE ALL LOGISTIC SERVICES
                        </h2>
                        <p>Future Logistic Transnational Company is the logistics and transportation hub of the Southeast and your direct access to the world. With an extensive line-up of distribution and warehousing facilities, world-class supply chain infrastructure, and the nation’s fastest-growing port, Future Logistic Transnational Company is ready to move your product efficiently and seamlessly.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="counterup-area bg-image padding-top-110 padding-bottom-285"
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-sm-11 col-11">
                        <div class="section-title white b-top desktop-center padding-top-25 margin-bottom-55">
                            <h2 class="title">Why choose Future Logistic Transnational Company</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="righti-content-area">
                        <div class="request-page-form-wrap">
                            ...
                            <form action="" class="request-page-form" novalidate="novalidate">
                                <div class="row">
                                    <div class="col-md-6">
                                        <select id="f-type">
    ...
    Client Section
========================-->
    <div class="client-section bg-liteblue padding-bottom-100 padding-top-100">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="client-area">
                        <div class="client-active-area">
                            <div class="single-brand">
                                <a href="#"><img src="{{ asset('logos/logo1.png') }}" alt=""></a>
                            </div>
                            <div class="single-brand">
                                <a href="#"><img src="{{ asset('logos/logo2.jpg') }}" alt=""></a>
                            </div>
                            <div class="single-brand">
                                <a href="#"><img src="{{ asset('logos/logo3.png') }}" alt=""></a>
                            </div>
                            <div class="single-brand">
                                <a href="#"><img src="{{ asset('logos/logo4.png') }}" alt=""></a>
                            </div>
                            <div class="single-brand">
                                <a href="#"><img src="{{ asset('logos/logo5.png') }}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
