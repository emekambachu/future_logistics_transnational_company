...
@section('contents')
    <div class="row">
        <div class="col-lg-12 col-md-12 text-left p-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="receiver_name" class="form-control" type="text" placeholder="Receiver Name" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="receiver_email" class="form-control" type="email" placeholder="Receiver Email" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="parcel" required>
                                ...
                                <option value="Delicate Parcel">Delicate Parcel</option>
                                <option value="Heavy Parcel">Heavy Parcel</option>
                            </select>
                        </div>
                    </div>
